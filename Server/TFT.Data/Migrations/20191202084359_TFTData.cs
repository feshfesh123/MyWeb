...
{
    public partial class TFTData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Top1 = table.Column<string>(nullable: true),
                    Top2 = table.Column<string>(nullable: true),
                    Top3 = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Joins", x => new { x.MatchId, x.UserId });
                    table.ForeignKey(
                        name: "FK_Joins_Matches_MatchId",
                        column: x => x.MatchId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Requests", x => new { x.MatchId, x.UserId });
                    table.ForeignKey(
